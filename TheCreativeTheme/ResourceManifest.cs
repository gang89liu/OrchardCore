...
namespace OrchardCore.Themes.TheCreativeTheme
{
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
               .DefineScript("TheCreativeTheme-vendor-jquery.popup")
               .SetDependencies("TheCreativeTheme-vendor-jQuery")
               .SetUrl("~/TheCreativeTheme/vendor/jquery-popup/jquery.magnific-popup.min.js", "~/TheCreativeTheme/vendor/jquery-popup/jquery.magnific-popup.min.js")
               .SetVersion("1.4.1");
